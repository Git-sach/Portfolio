...
export class ExperiencesComponent {
  ...
  public subTitle: string =
    'Voici une synthèse des expériences professionnelles à travers lesquelles j’ai pu développer mon expertise tant sur l’aspect définition des besoins que sur la mise en place de solutions pour y répondre.';
  public experiences = experiences;

  public imgLeft: string | null = this.experiences[0].props.style.img;
  ...
  public experienceClick(index: number): void {
    if (!this.experiences[index].props.style.isOpen) {
      this.experiences.forEach(
        (experience) => (experience.props.style.isOpen = false)
      );
    ...
    this.experiences[index].props.style.isOpen =
      !this.experiences[index].props.style.isOpen;
